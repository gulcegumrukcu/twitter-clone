    ...
    return (
        ...
        <>
            ...
            <header className="w-full ">
                ...
                <div className=' w-[608px]    pl-6 h-[50px]  flex items-center justify-between'>
                    ...
                    <div className="hover:bg-[#F0F3F5] p-2 mr-4 rounded-full cursor-pointer items-center flex justify-center">
                        <img className="w-4 h-4.5  " src="/img/navigation/icon-list.png" alt="" />
                    </div>
                    <div className="hover:bg-[#F0F3F5] p-2 mr-4 rounded-full cursor-pointer items-center flex justify-center">
                        <img className="w-3.5 h-3.5  " src="/img/profile/icon-settings.png" alt="" />
                    </div>
