            ...
            <div className='block mt-4 '>
                <div className=' flex  ml-5'>
                    ...
                    <div className="items-center   flex">
                        <button className='w-[88px] h-8  ml-12 rounded-2xl bg-black text-white font-bold text-sm'>Takip et</button>
                    </div>
                ...
                <div className=' flex mt-6 ml-5'>
                    ...
                    <div className='block ml-2 -mt-0.5'>
                        ...
                        <p className='text-gray-600 text-sm'>@AtakanYrlmz</p>
                    </div>
                    <div className="items-center flex">
                        <button className='w-[88px] h-8 ml-[15px] flex justify-center items-center  rounded-2xl bg-black text-white font-bold text-sm'>Takip et</button>
                    </div>
                ...
                <div className=' flex mt-6 ml-5'>
                    ...
                    <div className="items-center flex">
                        ...
                        <button className='w-[88px] h-8 ml-[19px]  rounded-2xl bg-black text-white font-bold text-sm'>Takip et</button>
                    </div>

                </div>
                <p className='text-[#4595f4] text-sm ml-5 mt-6'>Daha fazla göster</p>
            </div>
...
export default BunlariBegenebilirsin