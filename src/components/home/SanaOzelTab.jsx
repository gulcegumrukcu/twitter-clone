...
const TakipEdilenlerTab = () => {
    return <div className='h-[100%] '>
        ...
        <div className='flex flex-col w-[full] border border-gray-100 hover:bg-[#F7F7F7] h-[500px] flex-3 cursor-pointer'>
            ...
            <div className='flex flex-row '>
                ...
                <div className='flex flex-row gap-4 mb-6 items-center ml-2'>
        ...
        <div className='flex flex-col pt-2 w-full border border-gray-100 hover:bg-[#F7F7F7] h-[740px] flex-3 cursor-pointer'>
            ...
            <div className='flex flex-row '>
                ...
                <div className='flex   mb-6 items-center'>
                    <h4 className='text-gray-900 font-semibold hover:underline cursor-pointer '>Programmer Memes</h4>
            ...
            <div className='block'>
                <p className='text-sm ml-[74px] -mt-8 pr-2 mb-1' >"I am a PHP developer"</p>
                <p className='text-sm text-[#4595f4] font-medium ml-[74px] cursor-pointer hover:underline'>#ProgrammerMeme</p>
                <div className=' items-center flex justify-center ml-8 mb-2 mt-2'>
