...
const OneCikanlarTab = () => {
    return <div className='h-[100%] '>
        ...
        <div className='flex flex-col w-[full] hover:bg-[#F7F7F7] border border-gray-100 h-[420px] flex-3 cursor-pointer'>
        ...
        <div className='flex flex-col w-full  hover:bg-[#F7F7F7] border border-gray-100 h-28 flex-3 cursor-pointer'>
